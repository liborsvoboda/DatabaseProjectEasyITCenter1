CREATE TABLE [dbo].[SystemTranslationList] (
    ...
    [UserId]        INT           CONSTRAINT [DF_SystemTranslationList_UserId] DEFAULT ((0)) NULL,
    [Timestamp]     DATETIME2 (7) CONSTRAINT [DF_SystemTranslationList_Timestamp] DEFAULT (getdate()) NOT NULL,
