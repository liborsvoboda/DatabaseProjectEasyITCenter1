CREATE TABLE [dbo].[BusinessPaymentStatusList] (
    ...
    [UserId]      INT           NOT NULL,
    [Active]      BIT           CONSTRAINT [DF_PaymentStatusList_Active] DEFAULT ((1)) NOT NULL,
    [Receipt]     BIT           CONSTRAINT [DF_PaymentStatusList_Receipt] DEFAULT ((0)) NOT NULL,
    [CreditNote]  BIT           NOT NULL,
    [TimeStamp]   DATETIME2 (7) CONSTRAINT [DF_PaymentStatusList_TimeStamp] DEFAULT (getdate()) NOT NULL,
