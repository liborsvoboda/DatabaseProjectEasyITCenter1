CREATE TABLE [dbo].[ServerModuleAndServiceList] (
    ...
    [InheritedLayoutType]   VARCHAR (50)   CONSTRAINT [DF_ServerModuleAndServiceList_InheritedLayoutType] DEFAULT ('MultiLangLayout') NULL,
    ...
    [IsLoginModule]         BIT            CONSTRAINT [DF_ServerModuleAndServiceList_IsLoginModule] DEFAULT ((0)) NOT NULL,
    [PathSetAllowed]        BIT            NOT NULL,
    [RestrictionSetAllowed] BIT            NOT NULL,
    [HtmlSetAllowed]        BIT            NOT NULL,
    [RedirectSetAllowed]    BIT            NOT NULL,
    [Active]                BIT            CONSTRAINT [DF_ServerModuleAndServiceList_Active] DEFAULT ((1)) NOT NULL,
    [UserId]                INT            NOT NULL,
    [TimeStamp]             DATETIME2 (7)  CONSTRAINT [DF_ServerModuleAndServiceList_TimeStamp] DEFAULT (getdate()) NOT NULL,
