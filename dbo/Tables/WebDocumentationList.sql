CREATE TABLE [dbo].[WebDocumentationList] (
    ...
    [UserId]      INT           NOT NULL,
    [Active]      BIT           CONSTRAINT [DF_WebDocumentationList_Active] DEFAULT ((1)) NOT NULL,
    [AutoVersion] INT           NOT NULL,
    [TimeStamp]   DATETIME2 (7) CONSTRAINT [DF_WebDocumentationList_TimeStamp] DEFAULT (getdate()) NOT NULL,
